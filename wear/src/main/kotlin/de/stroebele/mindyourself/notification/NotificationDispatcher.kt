...
import de.stroebele.mindyourself.MainActivity
...
class NotificationDispatcher @Inject constructor(
    ...
    fun showMovementReminder(steps: Long, stepThreshold: Int, windowMinutes: Int, timeoutMinutes: Int?) = show(
    ...
    fun showSedentaryReminder(timeoutMinutes: Int?) = show(
    ...
    fun showHydrationReminder(todayMl: Int, dailyGoalMl: Int, timeoutMinutes: Int?) {
    ...
    fun showSupplementReminder(items: List<SupplementItem>, timeoutMinutes: Int?) {
    ...
    fun showScreenBreakReminder(timeoutMinutes: Int?) = show(
    ...
    private fun show(
        ...
        val notification = NotificationCompat.Builder(context, CHANNEL_ID)
            ...
            .setAutoCancel(true)
            .apply { timeoutMinutes?.let { setTimeoutAfter(it * 60_000L) } }
